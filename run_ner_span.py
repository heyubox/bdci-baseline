...
def main():
    ...
    parser.add_argument("--data_dir", default=os.getcwd()+'/datasets/cluener', type=str,
                        help="The input data dir. Should contain the training files for the CoNLL-2003 NER task.",)
    parser.add_argument("--model_type", default='bert', type=str,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()),)
    parser.add_argument("--model_name_or_path", default=os.getcwd()+'/prev_trained_model/chinese-bert-wwm', type=str,
                        help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(ALL_MODELS),)
    parser.add_argument("--output_dir", default=os.getcwd()+'/outputs/cluener_output', type=str,
    ...
    parser.add_argument("--eval_max_seq_length", default=512, type=int,
                        help="The maximum total input sequence length after tokenization. Sequences longer "
                             "than this will be truncated, sequences shorter will be padded.", )
    parser.add_argument("--do_train", action="store_true", default='True', help="Whether to run training.")  # NOTE: default用于debug
    parser.add_argument("--do_eval", action="store_true", default='True', help="Whether to run eval on the dev set.")  # NOTE: default用于debug
    ...
    parser.add_argument("--overwrite_output_dir", default='True', action="store_true",
                        help="Overwrite the content of the output directory")  # NOTE: default用于debug
    parser.add_argument("--overwrite_cache", default='True', action="store_true",
                        help="Overwrite the cached training and evaluation sets")  # NOTE: default用于debug
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        #     get_recent_checkpoint(args.output_dir), do_lower_case=args.do_lower_case)
        checkpoints = [args.output_dir]
        ...
        try:
            ...
            logging.error('No checkpoint to be predict, please check the output path')
